...
export function FeedbackButton() {
    const handleClick = () => {
        window.open("mailto:kc.jovenva@gmail.com?subject=JovenVA System Feedback", "_blank");
    };

    return (
        <div className="w-full flex justify-center py-4">
            <button className="button relative" onClick={handleClick}>
                <svg
        ...
        .button {
          ...
          align-items: center;
          user-select: none;
          font-family: inherit; /* Inherit font instead of Courier for consistency */
          font-size: 1rem;
          font-weight: bold;
        ...
        .highlight {
          ...
          width: 100%;
          height: 100%;
          fill: rgba(79, 209, 197, 0.2); /* Teal highlighter */
          stroke: rgba(79, 209, 197, 0.5); /* Teal stroke */
          stroke-width: 10;
        ...
        .button-cosm {
          ...
          scale: 0.5;
          position: absolute;
          /* Adjusted translate to fit smaller button text "FEEDBACK" */
          translate: calc(-100% + 10px) 1.5rem; 
          left: 0;
        }
